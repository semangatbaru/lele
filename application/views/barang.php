                ...
                <form enctype="multipart/form-data" class="form-horizontal" method="post" id="formnya" >
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                      <input type="text" class="form-control" id="id_barang_add" name="id_barang_add" placeholder="ID Barang">
                      </div>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    //set Kode Otomatis
    function setCode(){
      var id_barang = $('#id_barang_add').val();
      $.ajax({
          type: "POST",
          url: "<?php echo site_url('Barang/setCode') ?>",
          dataType: "JSON",
          data:{id_barang:id_barang},
          success : function(data){
              $('[name="id_barang_add"]').val(data);
          }
      });
      return false;
    }
